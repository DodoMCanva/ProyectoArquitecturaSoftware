...
//    private volatile List<SocketServerThread> threads;
//    private SocketServerProtocol ssp;
//    private Socket s;
//    private boolean votado;
//    private int MAX;
//
//    public SocketServerThread(Socket s, List<SocketServerThread> threads, int MAX) throws IOException {
//        this.s = s;
//        this.threads = threads;
//        this.votado = false;
//        this.ssp = new SocketServerProtocol();

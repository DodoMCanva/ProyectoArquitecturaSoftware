...
public class frmPuntaje extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, 530, 230));
...
//            java.util.logging.Logger.getLogger(frmScores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
